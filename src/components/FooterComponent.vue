  ...
  <div class="bg-gray-900">
    <div class="max-w-2xl mx-auto text-white py-10">
      <div class="text-center">
        <h3 class="text-3xl mb-3">Téléchargez Booktin</h3>
        <p>La montagne à portée de main.</p>
        <div class="flex justify-center my-10">
          <div class="flex items-center border w-auto rounded-lg px-4 py-2 w-52 mx-2">
            <img src="https://cdn-icons-png.flaticon.com/512/888/888857.png" class="w-7 md:w-8" />
            <div class="text-left ml-3">
              <p class="text-xs text-gray-200">Téléchargez sur</p>
      ...
      >
        <p class="order-2 md:order-1 mt-8 md:mt-0">&copy; Booktin, 2025.</p>
        <div class="order-1 md:order-2">
          <span class="px-2">A propos</span>
