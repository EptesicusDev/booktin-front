...
<template>
  <div class="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    >
      ...
      >
        <h3 id="tier-hobby" class="text-base/7 font-semibold text-primary">Hobby</h3>
        ...
        <a
          ...
          class="mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold text-primary ring-1 ring-indigo-200 ring-inset hover:ring-indigo-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:mt-10"
          >Get started today</a
        >
      </div>
      <div class="relative rounded-3xl bg-secondary p-8 ring-1 shadow-2xl ring-gray-900/10 sm:p-10 text-black">
        ...
        <a
          ...
          class="mt-8 block rounded-md bg-primary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:hover-bg-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 sm:mt-10"
          >Get started today</a
        >
      </div>
    </div>
